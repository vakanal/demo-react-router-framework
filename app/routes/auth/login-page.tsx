...
import { loginUser } from "~/faker/fake-data";
...
const LoginPage = ({ actionData }: Route.ComponentProps) => {
  ...
  const isPosting = navigation.state !== "idle";
        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          <Form className="p-6 md:p-8" method="post">
            <div className="flex flex-col gap-6">
              ...
              <Field className="grid gap-2" data-invalid={!!actionData?.error}>
                ...
                />
                {actionData?.error && (
                  <FieldDescription>{actionData.error}</FieldDescription>
                )}
              </Field>
